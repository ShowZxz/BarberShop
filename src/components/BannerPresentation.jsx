...
function BannerPresentation() {
  return (
    <div className="banner-container">
      <img class="banner-main-title" src="/images/logo_banner.png"></img>
      <div class="banner-zones">
        <div className="banner-content">
          ...
          <p className="banner-slogan">
            Découvrez une nouvelle façon de se couper les cheveux. Lorem ipsum
            dolor sit amet, consectetur adipiscing elit. Maecenas eget erat
            placerat, interdum velit a, elementum orci. In tempor turpis.
          </p>
